...
import { Trophy, CalendarDays, BookOpen, FileText as ReportIcon } from "lucide-react"; 
...
export default function StudentResultsPage() {
  const { currentUser, getExamResultsForStudent, getSubjectById, getExamPeriodById, getClassDetails, getExamPeriodsBySchool, loading: authLoading } = useAuth(); 
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl sm:text-3xl font-bold">My Exam Results</h1>
